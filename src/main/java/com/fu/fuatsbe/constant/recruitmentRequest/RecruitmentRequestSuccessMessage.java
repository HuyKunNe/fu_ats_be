...
public final class RecruitmentRequestSuccessMessage {

    public final static String GET_RECRUITMENT_REQUEST_BY_ID_SUCCESS = "Get recruitment request by id successfully";
    public final static String GET_ALL_RECRUITMENT_REQUEST_SUCCESS = "Get all recruitment request successfully";
    public final static String GET_OPEN_RECRUITMENT_PLAN_SUCCESS = "Get all opening recruitment request successfully";
    ...
    public final static String GET_EXPIRY_REQUEST_SUCCESS = "Get expiry date recruitment request successfully";
