...
public final class EmployeeSuccessMessage {
    ...
    public final static String DISABLE_EMPLOYEE_SUCCESS = "Disable employee successfully";
    public final static String ACTIVE_EMPLOYEE_SUCCESS = "Active employee successfully";
    public final static String COUNT_EMPLOYEE_SUCCESS = "Count employee successfully";
    public final static String GET_BY_LEVEL_SUCCESS = "Get name and code by job level successfully";
    public final static String SEND_LINK_VERIFY_TO_GET_BACK_PASSWORD_SUCCESS = "Send verify link to email success";
}
